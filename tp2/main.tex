...
\pagebreak
\inputcode{nasm}{./code/1e-a.txt}
\pagebreak
\inputcode{nasm}{./code/1e-b.txt}
Escribe \mintinline{text}{5!=5×4×3×2×1=120} en la salida.
